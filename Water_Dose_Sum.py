...
file_paths = [
    "./Data/Water/100MeV1cmWater_51.txt",
    "./Data/Water/100MeV2cmWater_51.txt",
    "./Data/Water/100MeV3cmWater_51.txt",
    "./Data/Water/100MeV4cmWater_51.txt",
    "./Data/Water/100MeV5cmWater_51.txt",
    "./Data/Water/100MeV6cmWater_51.txt",
    "./Data/Water/100MeV8cmWater_51.txt",
    "./Data/Water/100MeV10cmWater_51.txt",
    "./Data/Water/100MeV12cmWater_51.txt",
    "./Data/Water/100MeV15cmWater_51.txt",
    "./Data/Water/100MeV20cmWater_51.txt",
    "./Data/Water/100MeV30cmWater_51.txt"
]

thicknesses = [1, 2, 3, 4, 5, 6, 8, 10, 12, 15, 20, 30]  # Corresponding thickness in cm
...
fig.update_layout(
        title="Dose per Proton vs. Material Thickness (Water)",
