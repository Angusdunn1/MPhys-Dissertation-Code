...
results_dir = "./Results/1GeV_Storm/"
...
file_paths = [
    "./Data/1GeV Storm/1GeV_Storm_no_shield_51.txt",
    "./Data/1GeV Storm/1GeV_Storm_Shelter 30cm (Lead + Polyethylene)_51.txt",
    "./Data/1GeV Storm/1GeV_Storm_Shelter 1m (Pb + PE)_51.txt",
    "./Data/1GeV Storm/1GeV_Storm_Shelter(Titanium + Polyethylene)_51.txt",
    "./Data/1GeV Storm/1GeV_Storm_Shelter 1m (Ti + PE)_51.txt"
]

thicknesses = [0, 1, 2, 3, 4]  # Corresponding thickness in cm
