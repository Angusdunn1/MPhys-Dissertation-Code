...
results_dir = "./Results/Ti_Triple_Layer/"
...
file_paths = [
    "./Data/Triple_Layers/Ti + PE/100MeV(Ai+1cmTi+PE)_51.txt",
    "./Data/Triple_Layers/Ti + PE/100MeV(Ai+8cmTi+PE)_51.txt",
    "./Data/Triple_Layers/Ti + PE/100MeV(Ai+10cmTi+PE)_51.txt",
    "./Data/Triple_Layers/Ti + PE/100MeV(Ai+15cmTi+PE)_51.txt",
    "./Data/Triple_Layers/Ti + PE/100MeV(Ai+20cmTi+PE)_51.txt",
    "./Data/Triple_Layers/Ti + PE/100MeV(Ai+30cmTi+PE)_51.txt",
    "./Data/Triple_Layers/Ti + PE/100MeV(Ai+50cmTi+PE)_51.txt"
]

thicknesses = [1, 8, 10, 15, 20, 30, 50]  # Corresponding thickness in cm
...
fig.update_layout(
        title="Dose per Proton vs. Material Thickness (Al + Ti + PE)",
